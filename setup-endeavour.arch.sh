...
yay -S bspwm sxhkd polybar rofi alacritty zsh dunst xclip flameshot neofetch mpv telegram-desktop ibus-bamboo docker docker-compose python-pywal fzf ripgrep postman-bin starship ranger pamixer brightnessctl noto-fonts noto-fonts-emoji noto-fonts-cjk feh code neovim google-chrome cloudflare-warp-bin htop
